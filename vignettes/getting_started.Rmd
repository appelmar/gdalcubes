...
We will use 8-daily land surface temperature from the MODIS product [MOD11A2](https://lpdaac.usgs.gov/dataset_discovery/modis/modis_products_table/mod11a2_v006) , covering western Europe (tiles v=13,14, h=03,04) from January to September 2018. The zip archive has approximately 600 megabytes. The code below downloads and unzips the data to the current working directory. 
...
v = cube_view(srs=srs, extent=MOD11A2.col, nx = 633, dt="P1M", aggregation = "mean")
v
...
code for example derives monthly differences of land surface temperature. The `window_time` function here applies the simple time series kernel filter $T_t - T_{t-1}$.
