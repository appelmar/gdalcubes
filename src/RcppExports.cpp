...
// libgdalcubes_copy_cube
SEXP libgdalcubes_copy_cube(SEXP pin);
RcppExport SEXP _gdalcubes_libgdalcubes_copy_cube(SEXP pinSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type pin(pinSEXP);
    rcpp_result_gen = Rcpp::wrap(libgdalcubes_copy_cube(pin));
    return rcpp_result_gen;
END_RCPP
}
...
RcppExport SEXP _gdalcubes_libgdalcubes_create_stac_collection(SEXP bandsSEXP, SEXP imagesSEXP, SEXP gdalrefsSEXP, SEXP outfileSEXP, SEXP image_mdSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    libgdalcubes_create_stac_collection(bands, images, gdalrefs, outfile, image_md);
    return R_NilValue;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_gdalcubes_libgdalcubes_set_gdal_config", (DL_FUNC) &_gdalcubes_libgdalcubes_set_gdal_config, 2},
